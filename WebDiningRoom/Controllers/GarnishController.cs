...
namespace WebDiningRoom.Controllers
{
    ...
    {
        private readonly IGarnishServices ctx;
        public GarnishController(IGarnishServices garnishServices)
        {
            this.ctx = garnishServices;
        }
        ...
        // POST
        [HttpPost]
        public async Task<IActionResult> Create(CreateGarnishDto model)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Edit(EditGarnishDto model)
        {
