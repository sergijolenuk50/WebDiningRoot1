...
namespace WebDiningRoom.Controllers
{
    ...
    {
        private readonly ISaladServices ctx;
        public SaladController(ISaladServices saladServices)
        {
            this.ctx = saladServices;
        }
        [HttpGet("all")]
        ...
        // POST
        [HttpPost]
        public async Task<IActionResult> Create(CreateSaladDto model)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Edit(EditSaladDto model)
        {
