...
namespace WebDiningRoom.Controllers
{
    ...
    {
        private readonly IFirstDishesServices ctx;
        public FirstDishesController(IFirstDishesServices firstDishesServices)
        {
            this.ctx = firstDishesServices;
        }
        ...
        // POST
        [HttpPost]
        public async Task<IActionResult> Create(CreateFirstDishesDto model)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Edit(EditFirstDishesDto model)
        {
